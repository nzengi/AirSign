    ...
    <div style={{ marginBottom: 12 }}>
      ...
      <textarea
        ...
        style={{
          ...
          fontSize: 11,
          background: isPrivate ? "rgba(234,84,85,0.06)" : "var(--bg-2)",
          color: isPrivate ? "#b83030" : "var(--text)",
          border: isPrivate ? "1px solid rgba(234,84,85,0.30)" : "1px solid var(--border)",
          borderRadius: 6,
          padding: 8,
          resize: "vertical",
  ...
  return (
    <span
      style={{
        ...
        height: 28,
        borderRadius: "50%",
        background: done ? "var(--accent2)" : active ? "var(--accent)" : "var(--border-strong)",
        color: "#fff",
        fontWeight: 700,
        fontSize: 13,
        marginRight: 8,
      ...
      >
        {[
          ...
          >
            ...
            <span style={{ fontSize: 13, color: si === i ? "var(--accent)" : "var(--muted)" }}>
              {label}
            </span>
            {i < 4 && (
              <span style={{ marginLeft: 8, color: "var(--border-strong)" }}>→</span>
            )}
          </div>
        ))}
      </div>
          ...
          <div style={{ display: "grid", gap: 12 }}>
            ...
            <div style={{ display: "flex", gap: 24 }}>
              <div>
                ...
                <p style={{ color: "var(--text)", margin: "2px 0 0", fontSize: 18, fontWeight: 700 }}>
                  {result.threshold}
                </p>
              </div>
              <div>
              ...
              <div>
                ...
                <p style={{ color: "var(--ok)", margin: "2px 0 0", fontSize: 18, fontWeight: 700 }}>
