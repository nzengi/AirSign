...
//!   brute-force attacks. Default parameters: m=65536 KiB, t=3, p=1.
...
///
/// Set to `1` to match OWASP 2024 Password Storage Cheat Sheet recommendations
/// and because the browser WASM runtime is single-threaded — `p > 1` would
/// add per-lane setup overhead without delivering any wall-clock speedup.
...
///
/// let params = Argon2Params { m_cost: 131_072, t_cost: 4, p_cost: 1 };
/// ```
...
impl Default for Argon2Params {
    /// OWASP 2024 minimum: m=64 MiB, t=3, p=1.
    fn default() -> Self {
        Self {
...
pub enum SecurityProfile {
    /// OWASP 2024 minimum — 64 MiB, t=3, p=1. Default for all sessions.
    Owasp2024,
    /// Mainnet-recommended — 256 MiB, t=4, p=1.
    Mainnet,
    /// Maximum practical hardening — 512 MiB, t=5, p=1.
    Paranoid,
}
...
impl SecurityProfile {
    ...
    pub fn description(self) -> &'static str {
        match self {
            SecurityProfile::Owasp2024 => "OWASP 2024 minimum (m=64 MiB, t=3, p=1)",
            SecurityProfile::Mainnet   => "mainnet-recommended (m=256 MiB, t=4, p=1)",
            SecurityProfile::Paranoid  => "paranoid (m=512 MiB, t=5, p=1)",
        }
    }
...
mod tests {
    ...
    fn meets_mainnet_minimum_correct() {
        ...
        let edge = Argon2Params { m_cost: ARGON2_M_COST_MAINNET, t_cost: ARGON2_T_COST_MAINNET, p_cost: 1 };
        assert!(edge.meets_mainnet_minimum());
        // Just below boundary
        let below = Argon2Params { m_cost: ARGON2_M_COST_MAINNET - 1, t_cost: ARGON2_T_COST_MAINNET, p_cost: 1 };
